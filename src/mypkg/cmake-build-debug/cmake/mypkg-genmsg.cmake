...
message(STATUS "mypkg: 1 messages, 0 services")

set(MSG_I_FLAGS "-Imypkg:/home/kt/Desktop/ros_test/src/mypkg/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/kt/Desktop/ros_test/src/mypkg/msg/point.msg" NAME_WE)
add_custom_target(_mypkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "mypkg" "/home/kt/Desktop/ros_test/src/mypkg/msg/point.msg" ""
)
...
_generate_msg_cpp(mypkg
  "/home/kt/Desktop/ros_test/src/mypkg/msg/point.msg"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Messages
_generate_msg_eus(mypkg
  "/home/kt/Desktop/ros_test/src/mypkg/msg/point.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/mypkg
)

### Generating Services

### Generating Module File
_generate_module_eus(mypkg
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/mypkg
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(mypkg_generate_messages_eus
  DEPENDS ${ALL_GEN_OUTPUT_FILES_eus}
)
add_dependencies(mypkg_generate_messages mypkg_generate_messages_eus)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/kt/Desktop/ros_test/src/mypkg/msg/point.msg" NAME_WE)
add_dependencies(mypkg_generate_messages_eus _mypkg_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(mypkg_geneus)
add_dependencies(mypkg_geneus mypkg_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS mypkg_generate_messages_eus)
...
### Generating Messages
_generate_msg_nodejs(mypkg
  "/home/kt/Desktop/ros_test/src/mypkg/msg/point.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/mypkg
)

### Generating Services

### Generating Module File
_generate_module_nodejs(mypkg
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/mypkg
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(mypkg_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(mypkg_generate_messages mypkg_generate_messages_nodejs)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/kt/Desktop/ros_test/src/mypkg/msg/point.msg" NAME_WE)
add_dependencies(mypkg_generate_messages_nodejs _mypkg_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(mypkg_gennodejs)
add_dependencies(mypkg_gennodejs mypkg_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS mypkg_generate_messages_nodejs)
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/mypkg)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/mypkg
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(mypkg_generate_messages_eus std_msgs_generate_messages_eus)
endif()
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/mypkg)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/mypkg
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(mypkg_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/mypkg)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/mypkg\")")
  # install generated code
  install(
